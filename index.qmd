...
pgm.add_node("lemons", "Lemons", 1.5, 2.5, observed=True, scale=2.7,
             plot_params={"fc": "yellow"})
pgm.add_node("vitc", "Vitamin C", 4.0, 2.5, scale=3)
pgm.add_node("scurvy", "Scurvy Prevention", 6.5, 2.5, observed=True, scale=4,
             plot_params={"fc": "lightgreen"})

pgm.add_edge("lemons", "vitc")
pgm.add_edge("vitc", "scurvy")
